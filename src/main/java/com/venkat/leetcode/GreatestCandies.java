...
public class GreatestCandies {
    ...
    public static boolean[] kidsWithCandies(int[] candies, int extraCandies) {
        ...
        // Check if adding extraCandies makes each kid have the greatest number of candies
        for (int i = 0; i < n; i++) {
    ...
    public static List<Boolean> kidsWithCandiesWithList(int[] candies, int extraCandies) {
        int n = candies.length;
        int maxCandies = 0;
        ...
        // Check if adding extraCandies makes each kid have the greatest number of candies
        for (int i = 0; i < n; i++) {
            resultList.add((candies[i] + extraCandies >= maxCandies));
        }
    ...
    public static void main(String[] args) {
        ...
        for (boolean canHaveGreatestCandies : result) {
            System.out.println(canHaveGreatestCandies);
        }
        // Output: true, true, true, false, true
    }
}
